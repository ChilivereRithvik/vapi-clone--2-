  ...
  nodes: [
    {
      ...
      prompt: "You are a helpful widget assistant",
      messagePlan: {
...
export default function WidgetFlowsPage() {
  ...
  const handleCreateWorkflow = (templateId: string, name: string) => {
    console.log("[v0] Creating widget workflow:", { templateId, name });
    navigate(`/widgets/flows/new`);
  };
  ...
  const handleDeleteConfirm = () => {
    console.log("[v0] Deleting widget workflow:", workflowToDelete);
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <h1 className="text-3xl font-bold">Widget Workflows</h1>
            <Badge
              variant="secondary"
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="relative flex-1 max-w-sm">
            ...
            <Input
              placeholder="Search widget workflows..."
              value={searchQuery}
              ...
              <TableBody>
                {paginatedWorkflows.map((workflow) => (
                  <TableRow
                    ...
                    onClick={() => navigate(`/widgets/flows/${workflow.id}`)}
                  >
        ...
        <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will permanently delete the widget workflow "
